    ...
    return (
        <div className="m-auto text-center">
            ...
            <div className="flex justify-center gap-24 pb-12 text-xl">
                <Link to="/users" className="text-white bg-black rounded-xl py-2 px-4 cursor-pointer transition duration-1000 ease-out hover:-translate-y-1">Users</Link>
                <Link to="/albums" className="text-white bg-black rounded-xl py-2 px-4 cursor-pointer transition duration-1000 ease-out hover:-translate-y-1">Albums</Link>
            </div>
